...
SECRET_KEY = 'django-insecure--1o8g7k=7s=#zx3@q3evc7#c3j23!$cbg@3)c16^xgh1r5%as1'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'), ('images', os.path.join(BASE_DIR, 'static_images')),
